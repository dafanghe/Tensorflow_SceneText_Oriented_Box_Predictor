...
#from models import faster_rcnn_densenet_inception_feature_extractor as frcnn_den_inc
from models import faster_rcnn_resnet_v1_feature_extractor as frcnn_resnet_v1
from models import faster_rcnn_vgg16_feature_extractor as frcnn_vgg16
from models import faster_rcnn_mobilenet_v1_feature_extractor as frcnn_mobilenet_v1
...
FASTER_RCNN_FEATURE_EXTRACTOR_CLASS_MAP = {
    ...
    #'faster_rcnn_densenet_inception':
    #frcnn_den_inc.FasterRCNNDenseNetFeatureExtractor,
}
...
def _build_ssd_model(ssd_config, is_training):
  ...
  (classification_loss, localization_loss, classification_weight,
   localization_weight, oriented_localization_loss,
...
def _build_faster_rcnn_model(frcnn_config, is_training):
  ...
  second_stage_localization_loss_weight_oriented = (
      frcnn_config.second_stage_localization_loss_weight_oriented)
