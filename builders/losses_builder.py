...
def build(loss_config):
  ...
  oriented_localization_weight = loss_config.oriented_localization_weight
  ...
  return (classification_loss, localization_loss,
          classification_weight,
          localization_weight, oriented_localization_weight,
          hard_example_miner)
...
def _build_classification_loss(loss_config):
  ...
  if loss_type == 'focal_sigmoid':
    ...
    return losses.FocalClassificationLoss(
        anchorwise_output=config.anchorwise_output)
  raise ValueError('Empty loss config.')
