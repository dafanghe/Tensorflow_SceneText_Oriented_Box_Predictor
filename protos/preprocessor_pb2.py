...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_rotate_image', full_name='protos.PreprocessingStep.random_rotate_image', index=23,
...
_RANDOMROTATEIMAGE = _descriptor.Descriptor(
  name='RandomRotateImage',
  full_name='protos.RandomRotateImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_angle', full_name='protos.RandomRotateImage.min_angle', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_angle', full_name='protos.RandomRotateImage.max_angle', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(30),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREPROCESSINGSTEP.fields_by_name['random_rotate_image'].message_type = _RANDOMROTATEIMAGE
...
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_rotate_image'])
_PREPROCESSINGSTEP.fields_by_name['random_rotate_image'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
...
DESCRIPTOR.message_types_by_name['RandomRotateImage'] = _RANDOMROTATEIMAGE
...
RandomRotateImage = _reflection.GeneratedProtocolMessageType('RandomRotateImage', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMROTATEIMAGE,
  __module__ = 'protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:protos.RandomRotateImage)
  ))
_sym_db.RegisterMessage(RandomRotateImage)
