...
"""Densenet Inception Faster R-CNN implementation.
...
class FasterRCNNDenseNetFeatureExtractor(
  ...
  def __init__(self,
    ...
    super(FasterRCNNDenseNetFeatureExtractor, self).__init__(
    ...
    with slim.arg_scope(densenet.densenet_arg_scope(
      ...
      with slim.arg_scope([slim.batch_norm], is_training=False):
        with tf.variable_scope('DenseNet',
          ...
          rpn_feature_map = densenet.Dense_net(
                    preprocessed_inputs, nb_blocks=2,
                    filters=24, is_training=True, dropout_ratio=0.2)
